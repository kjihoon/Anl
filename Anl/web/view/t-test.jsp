            ...
            <div class="card-body">
               <div class="horizontal-form-elements">
                  <form id="ttestform" class="form-horizontal">
                     ...
                     <input type="hidden" name="alternative2">
                     <input type="hidden" name="conflevel">
                      <input type="hidden" name="conflevel2">
         ...
         <div  class="card">
            <div  class="col-lg-12">
                  ...
                  <div class="form-group">
                     <div class="bttonn-list">
                        <div class="btn-group-vertical">
                           <p>Variable<code>(Required)</code></p>
               ...
               <div class="row">
                  <div class="col-lg-4">
                     <div class="form-group">
                        <p>Alternative<code>(default: Two.Sided)</code></p>
                  ...
                  <div class="col-lg-4">
                     <div class="form-group">
                        <p>Confidence level<code>(default: 0.95)</code></p>
                        <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
            ...
            <div  class="col-lg-12">
               ...
               <div class="card-body">                  
                   ...
                   <div class="form-group">
                     <div class="bttonn-list">
                        <div class="btn-group-vertical">
                           <p>Variable(X0)<code>(Required)</code></p>
                           <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                           <span name="x0" class="caret">select</span></button>
                        ...
                        <div class="btn-group-vertical">
                           <p>Variable(X1)<code>(Required)</code></p>
                           <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  ...
                  <div class="col-lg-4">
                     <div class="form-group">
                        <p>Alternative<code>(default: Two.Sided)</code></p>
                        <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <span name="alternative2" class="caret">select</span></button>
                        <ul name="select" id="alternative2" class="dropdown-menu" role="menu">
                           <li name="two.sided">Two.Sided</li>
                           <li name="less">One.Sided(Less)</li>
                           <li name="greater">One.Sided(Greater)</li>
                        </ul>
                     ...
                     <div class="form-group">
                        <p>mu<code>(default: 0, H0: mean of X = 0)</code></p>
                        <p class="text-muted m-b-15 f-s-12">Please input it yourself</p>
                        <input type="text" id="ttestonemu2"  class="form-control input-rounded" placeholder="0">
                     </div>
                     
                     <!--  -->
                      <div class="form-group">
                        <p>Independence<code>(default: not paired)</code></p>
                        <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <span name="paired" class="caret">select</span></button>
                  ...
                  <div class="col-lg-4">
                     <div class="form-group">
                        <p>Confidence level<code>(default: 0.95)</code></p>
                        <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <span name="conflevel2" class="caret">select</span></button>
                        <ul name="select" id="conflevel2" class="dropdown-menu" role="menu">
                           <li name="0.99">99%</li>
                           <li name="0.97">97%</li>
                           <li name="0.95">95%</li>
                           <li name="0.9">90%</li>
                     ...
                     <div id="directinput2" class="form-group">
                        <p class="text-muted m-b-15 f-s-12">Please input it yourself <code>(0~ 1.0) </code></p>
                        <input type="text" id="ttestoneconflevel2" class="form-control input-rounded" placeholder="0.95">
                     </div>
                      <div class="form-group">
                        <p>Equality of Variances<code>(default: not equal)</code></p>
                        <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <span name="varequal" class="caret">select</span></button>
                        <ul name="select" id="varequal" class="dropdown-menu" role="menu">
                           <li name="T">equal</li>
